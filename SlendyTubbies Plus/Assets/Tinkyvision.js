...
public var PlayerIndicator: GameObject;
public var indicatorOffset : Vector3 = Vector3(0, 1.07, 0);
...
function Update()
{
    ...
    if (EnemyScriptPlayer.tinkyInvisible && !fogApplied)
    {
        ...
        {
            var pi = Instantiate(PlayerIndicator, thePlayer.transform.position, thePlayer.transform.rotation) as GameObject;
            pi.transform.SetParent(thePlayer.transform); 
            pi.transform.localPosition = indicatorOffset;
